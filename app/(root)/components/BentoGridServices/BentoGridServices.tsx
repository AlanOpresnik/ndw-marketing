...
function BentoGridItem({ className, title, description, icon }: BentoGridItemProps) {
  return (
    <Card
      className={cn(
        "bento-item opacity-0 will-change-transform hover:!scale-102 hover:shadow-white/10 translate-y-8 flex flex-col justify-between !p-6 bg-white/5 backdrop-blur-lg border border-neutral-700/50 text-neutral-50 shadow-xl transition-all",
        className
      )}
    >
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ScrollTrigger.batch(".bento-item", {
        ...
        start: "top 85%",
        once: true, // evita reanimar al volver a hacer scroll
      });
    }, containerRef);
      ...
      <div className="container !px-4 md:!px-6 !z-10">
        <div className="text-center !mb-12">
          ...
          <p className="!mt-4 text-xl text-neutral-300">
            En NDW Agencia Digital potenciamos tu marca desde la estrategia hasta la ejecución.
          </p>
